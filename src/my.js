...
async function mySetStoremanGroupConfig() {
  ...
  let receipt = await setStoremanGroupConfig(sgaWan, smgID1, 5, deposit1, [0x8057414e, 2147483708], [0, 0], gpk1_1, gpk1_2, startTime, endTime);
  console.log(JSON.stringify(receipt));

  const deposit2 = '0x' + web3.utils.toWei("900000000").toString('hex');
  receipt = await setStoremanGroupConfig(sgaWan, smgID2, 5, deposit2, [0x8057414e, 2147483708], [0, 0], gpk2_1, gpk2_2, startTime, endTime);
  console.log(JSON.stringify(receipt));
}
