...
class TokenManager extends Contract {
  ...
  async addToken(name, symbol, decimals) {
    ...
    return await this.doOperator(this.addToken.name, data, null, '0x00', 7, this.pv_key, this.pv_address);
  }
  ...
  async addTokenPair(id, aInfo, fromChainID, fromAccount, toChainID, tokenAddress) {
    ...
    return await this.doOperator(this.addTokenPair.name, data, null, '0x00', 7, this.pv_key, this.pv_address);
  }
}
